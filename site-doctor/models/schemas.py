...
class Issue(BaseModel):
    ...
    suggested_solution: str | None = Field(
        None, description="Concrete, actionable fix text generated by fix_node -- PROPOSE step only, no HTML touched"
    )
    solution_sources: list[str] = Field(
        default_factory=list, description="URLs cited by the web-search-eligible (HIGH/MEDIUM severity) fix suggestion path"
    )
